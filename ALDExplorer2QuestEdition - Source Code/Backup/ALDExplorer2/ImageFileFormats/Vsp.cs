...
namespace ALDExplorer2.ImageFileFormats
{
    ...
    public struct VspHeaderRaw
    {
        public UInt16 X, Y, Right, Bottom;
        public byte Is8Bit, PaletteBank;
    }

    public class VspHeader : ICloneable, IImageHeader
    {
        public int X;
        public int Y;
        public int Width;
    ...
    public static class Vsp
    {
        ...
        public static void SaveHeader(VspHeader vspHeader, Stream stream)
        {
            ...
            bw.Write((short)vspHeader.X);
            bw.Write((short)vspHeader.Y);
            bw.Write((short)(vspHeader.Width + vspHeader.X));
            bw.Write((short)(vspHeader.Height + vspHeader.Y));
        ...
        public static VspHeader GetHeader(byte[] bytes)
        {
            ...
            vspHeader.X = BitConverter.ToInt16(bytes, 0);
            vspHeader.Y = BitConverter.ToInt16(bytes, 2);
            vspHeader.Width = BitConverter.ToInt16(bytes, 4) - vspHeader.X;
            vspHeader.Height = BitConverter.ToInt16(bytes, 6) - vspHeader.Y;
